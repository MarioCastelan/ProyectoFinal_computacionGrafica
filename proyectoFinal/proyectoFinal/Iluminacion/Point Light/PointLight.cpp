...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Luz Direccional", nullptr, nullptr);
	...
	// Load textures
	GLuint texture1, texture2,emmisionmap;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "light.linear"),0.7f );
		glUniform1f(glGetUniformLocation(lightingShader.Program, "light.quadratic"),1.8f );
